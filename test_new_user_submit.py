...
def test_new_user_submit():
    ...
    print("\n1. 新被试者登录...")
    login_data = {
        "username": "user6",  # 使用rr用户
        "password": "user123"  # 修改密码
    }
        ...
        if response.status_code == 200:
            ...
            if response.status_code == 200:
                ...
                for assignment in assignments:
                    print(f"   分配ID: {assignment['id']}, 状态: {assignment['status']}, 试卷: {assignment['paper_name']}")
                ...
                if available_assignment:
                    ...
                    print(f"\n   使用分配ID: {assignment_id} (状态: {available_assignment['status']})")
                    ...
                    if response.status_code == 200:
                        ...
                        answers = {}
                        for question in questions[:60]:  # 答前60题
